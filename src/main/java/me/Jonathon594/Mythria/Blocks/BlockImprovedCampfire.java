...
public class BlockImprovedCampfire extends MythriaBlock implements ITileEntityProvider {
    ...
    public BlockImprovedCampfire(final Material materialIn, final String nameIn,
        ...
        setDefaultState(this.getDefaultState().withProperty(BURNING, false).withProperty(FULL, false));
    }
    ...
    public TileEntity createNewTileEntity(final World worldIn, final int meta) {
        return new TileEntityImprovedCampfire();
    }

    @Override
    protected BlockStateContainer createBlockState() {
        return new BlockStateContainer(this, FULL, BURNING);
    }
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        ...
        if (tileentity instanceof TileEntityImprovedCampfire) {
            TileEntityCookingFireAdvanced teic = (TileEntityImprovedCampfire) tileentity;
            if(teic.getTicksLeft() > 0) {
                full = true;
            }
        }
    ...
    public void breakBlock(final World worldIn, final BlockPos pos, final IBlockState state) {
        ...
        if (te != null && te instanceof TileEntityCookingFireAdvanced) {
            final ItemStackHandler cookItems = ((TileEntityCookingFireAdvanced) te).getCookItems();
    ...
    public boolean onBlockActivated(final World world, final BlockPos pos, final IBlockState state,
        ...
        if (te instanceof TileEntityCookingFireAdvanced) {
            final TileEntityCookingFireAdvanced cf = (TileEntityCookingFireAdvanced) te;
            ...
            if (cf.isLit()) {
                ...
                player.openGui(Mythria.instance, MythriaGui.MYTHRIA_OPEN_CAMPFIRE_IMPROVED_GUI.ordinal(), world,
