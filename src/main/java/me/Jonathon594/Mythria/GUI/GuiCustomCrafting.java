...
public class GuiCustomCrafting extends GuiContainer implements IRecipeShownListener {
    private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES = new ResourceLocation("mythria:textures/gui/container/crafting_table.png");
    private final GuiRecipeBook recipeBookGui;
    private GuiButtonImage recipeButton;
    private boolean widthTooNarrow;

    public GuiCustomCrafting(InventoryPlayer playerInv, World worldIn) {
        this(playerInv, worldIn, BlockPos.ORIGIN);
    }

    public GuiCustomCrafting(InventoryPlayer playerInv, World worldIn, BlockPos blockPosition) {
    ...
    public void initGui() {
        ...
        this.recipeBookGui.func_194303_a(this.width, this.height, this.mc, this.widthTooNarrow, ((ContainerCustomWorkbench) this.inventorySlots).craftMatrix);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 10) {
            this.recipeBookGui.initVisuals(this.widthTooNarrow, ((ContainerCustomWorkbench) this.inventorySlots).craftMatrix);
